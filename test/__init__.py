...
class TestMemcache(TestCase):
    ...
    def test_basic(self):
        ...
        self.assertLastCall('incr', incr, 'simple incr')
        # decr
        self.assertFalse(client.decr(non_existent),
                         'simple decr, non-existent')
